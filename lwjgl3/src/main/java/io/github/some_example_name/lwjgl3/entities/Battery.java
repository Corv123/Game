...
public class Battery extends Entity implements CollisionHandler {
    private SceneManager sceneManager;
    private AudioManager audioManager;

    public Battery(Texture texture, float x, float y, float speed, float scale, SpriteBatch batch, SceneManager sceneManager, AudioManager audioManager) {
