...
public class Can extends Entity implements CollisionHandler {
    private SceneManager sceneManager;
    private AudioManager audioManager;

    public Can(Texture texture, float x, float y, float speed, float scale, SpriteBatch batch, SceneManager sceneManager, AudioManager audioManager) {
